/*
 * This class is a basic non-terminal enum class that is used to model the 
 * first sets of the productions in the Crux grammar.
 * 
 * @author John Palomo
 * Date: 4/21/2014
